...
public class Transaction {
    ...
    public class Output {
        ...
        public Output(double v, PublicKey addr,String _name) {
            value = v;
            address = addr;
            name = _name;
        }
    ...
    public void addOutput(double value, PublicKey address,String name) {
        Output op = new Output(value, address,name);
        outputs.add(op);
    }
